...
const WorkerChat = () => {
  ...
  const recipientName = searchParams.get('name') || 'Provider';
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      ...
      try {
        const res = await workerAPI.getChatHistory(recipientId);
    ...
    return (
      <div className="chat-page">
        ...
        <div className="empty-state">
          ...
          <p>Accept a job to start chatting with providers</p>
        </div>
      </div>
    );
  }
